"""
Adds support for Relative hygrostat units.
...
DEFAULT_NAME = 'Relative hygrostat'
...
def async_setup_platform(hass, config, async_add_devices, discovery_info=None):
    """Set up the Relative hygrostat platform."""
    ...
    async_add_devices([RelativeHygrostat(
        hass, name, sensor_id, delta_trigger, target_offset, min_on_time, max_on_time, sample_interval, min_humidity)])


class RelativeHygrostat(Entity):
    """Representation of a Relative hygrostat device."""
